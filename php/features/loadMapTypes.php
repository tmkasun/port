...
<img alt='Local GoogleMaps' width='50%' onclick="changeMapTileServer('localGoogleMaps')" src='../media/images/icons/network_local.png'/><br/><span style="color: fuchsia;">google Maps (Local)</span><br/>
